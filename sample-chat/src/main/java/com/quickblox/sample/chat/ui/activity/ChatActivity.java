...
import com.quickblox.sample.chat.services.CallService;
...
import com.quickblox.sample.chat.utils.CollectionsUtils;
import com.quickblox.sample.chat.utils.Consts;
import com.quickblox.sample.chat.utils.PermissionsChecker;
import com.quickblox.sample.chat.utils.PushNotificationSender;
import com.quickblox.sample.chat.utils.WebRtcSessionManager;
...
public class ChatActivity extends BaseActivity implements OnImagePickedListener {
    ...
    private boolean isLoggedInChat() {
        if (!QBChatService.getInstance().isLoggedIn()) {
            Toaster.shortToast("Please check internet connection");
            tryReLoginToChat();
            return false;
        }
        return true;
